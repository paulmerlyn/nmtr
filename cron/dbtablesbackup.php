...
$sendto = "Webmaster <paul@mediationtrainings.org>";
$sendfrom = "Automated Backup <donotreply@mediationtrainings.org>";
$sendsubject = "Daily MySQL Backup for ".date("F d, Y")." (National Mediation Training Registry)";
