...
*/
function poptasticDIY(url, HT, WD, topPos, scrY, leftPos, scrX, sclBars) // This general-purpose window function gets used by sales.php to display waitlist.php and by ipwirescrossed_slave.php to display ipwirescrossedpreview.php.
{
	...
	newwindow=window.open(url,'showmeontop',myParams);
