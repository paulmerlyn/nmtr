<?php
/*
adminaddtrainer.php allows an administrator (user) to add a new trainer to the trainers_table. The processing of this script is performed by adminaddtrainer_slave.php. Note that the trainer's Username and Password are assigned automatically inside adminaddtrainer_slave.php (drawing from userpass_table).
*/
// Start a session
session_start();
?>
...
<title>Add Trainer | Administrator of Mediation Training Registry</title>
...
<div style="margin-top: 10px; margin-left: -15px; text-align: center; padding: 0px;">
<form method="post" action="/scripts/unwind.php">
<a class="submitLinkSmall" href="/index.php">Home</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
if  (empty($Authentication) && $_SESSION['Authenticated'] != 'true')
	...
	if ((sha1($Authentication) == 'dc6a59aab127063fd353585bf716c7f7c34d2aa0') || $_SESSION['Authenticated'] == 'true')
		...
		$_SESSION['Authenticated'] = 'true';
			...
			<h1 style="text-align: left;">Add a trainer to the database:</h1>
			<br>
			...
			<td align="left" width="175"><a name="CityAnchor" class="plain"><input type="text" name="City" id="City" maxlength="30" size="20" onFocus="this.style.background='#FFFF99'" onBlur="this.style.background='white'; hideAllErrors(); return checkCityOnly();"></a><span class="redsup">&nbsp;&nbsp;<b>*</b></span></td>
			<td width="250">
			...
			<label>Zip</label>&nbsp;&nbsp;<a name="ZipAnchor" class="plain"><input type="text" name="Zip" id="Zip" maxlength="5" size="5" onFocus="this.style.background='#FFFF99'" onBlur="this.style.background='white'; hideAllErrors(); return checkZipOnly();"></a><span class="redsup">&nbsp;&nbsp;<b>*</b></span>
			</td>
			</tr>
			...
			<td colspan="3" align="left"><a name="TelephoneAnchor" class="plain"><input type="text" name="Tel1" id="Tel1" maxlength="3" size="3" onFocus="this.style.background='#FFFF99'" onBlur="this.style.background='white';"></a>&nbsp;&nbsp;&nbsp;<input type="text" name="Tel2" id="Tel2" maxlength="3" size="3" onFocus="this.style.background='#FFFF99'" onBlur="this.style.background='white';">&nbsp;&ndash;&nbsp;
			  <input type="text" name="Tel3" id="Tel3" maxlength="4" size="4" onFocus="this.style.background='#FFFF99'" onBlur="this.style.background='white'; hideAllErrors(); return checkTelephoneOnly();">
...
<div class="error" id="TelephoneError"><br>Please enter a valid telephone number. Use only numbers (0-9).<br></div><?php if ($_SESSION['MsgTelephone'] != null) { echo $_SESSION['MsgTelephone']; $_SESSION['MsgTelephone']=null; } ?></td>
			...
			<td align="left">
			<a name="TrainingsOfferedAnchor" class="plain"><input type="checkbox" name="BasicMed" id="BasicMed" value="true"></a><label>&nbsp;&nbsp;Basic Mediation</label><br>
			...
			<input type="checkbox" name="OtherMed" id="OtherMed" value="true"><label>&nbsp;&nbsp;Other</label>
			</td>
			</tr>
			<tr>
			<td>&nbsp;</td>
			...
			<td colspan="3" align="left"><a name="EntityHomePageAnchor" class="plain"><input type="text" name="EntityHomePage" id="EntityHomePage" maxlength="150" size="50" onFocus="this.style.background='#FFFF99'" onBlur="this.style.background='white'; hideAllErrors(); return checkEntityHomePageOnly();"></a>
			...
			<td colspan="3" align="left"><a name="EntityEmailAnchor" class="plain"><input type="text" name="EntityEmail" id="EntityEmail" maxlength="50" size="50" onFocus="this.style.background='#FFFF99'" onBlur="this.style.background='white'; hideAllErrors(); return checkEntityEmailOnly();"></a>
			...
			<td colspan="3" align="left"><a name="TrainerName2Anchor" class="plain"><input type="text" name="TrainerName2" id="TrainerName2" maxlength="30" size="30" onFocus="this.style.background='#FFFF99'" onBlur="this.style.background='white'; hideAllErrors(); return checkTrainerNameOnly('TrainerName2', 'TrainerName2Error', 'TrainerName2Anchor');"></a>
			...
			<td colspan="3" align="left"><a name="TrainerName3Anchor" class="plain"><input type="text" name="TrainerName3" id="TrainerName3" maxlength="30" size="30" onFocus="this.style.background='#FFFF99'" onBlur="this.style.background='white'; hideAllErrors(); return checkTrainerNameOnly('TrainerName3', 'TrainerName3Error', 'TrainerName3Anchor');"></a>
			...
			<td colspan="3" align="left"><a name="TrainerName4Anchor" class="plain"><input type="text" name="TrainerName4" id="TrainerName4" maxlength="30" size="30" onFocus="this.style.background='#FFFF99'" onBlur="this.style.background='white'; hideAllErrors(); return checkTrainerNameOnly('TrainerName4', 'TrainerName4Error', 'TrainerName4Anchor');"></a>
			...
			<td colspan="3" align="left"><a name="TrainerName5Anchor" class="plain"><input type="text" name="TrainerName5" id="TrainerName5" maxlength="30" size="30" onFocus="this.style.background='#FFFF99'" onBlur="this.style.background='white'; hideAllErrors(); return checkTrainerNameOnly('TrainerName5', 'TrainerName5Error', 'TrainerName5Anchor');"></a>
			...
			<td colspan="3" align="left"><a name="TrainerName6Anchor" class="plain"><input type="text" name="TrainerName6" id="TrainerName6" maxlength="30" size="30" onFocus="this.style.background='#FFFF99'" onBlur="this.style.background='white'; hideAllErrors(); return checkTrainerNameOnly('TrainerName6', 'TrainerName6Error', 'TrainerName6Anchor');"></a>
			...
			<select name="MemberLevel" id="MemberLevel" size="1">
...
<span class="redsup">&nbsp;&nbsp;<b>*</b></span>
			...
			<td colspan="4" align="center"><input type="submit" name="AdminAddTrainer" class="buttonstyle" style="margin-left: 0px;" value="Add Trainer" onClick="return checkForm();" <?php if ($rowAvail == 0) echo 'disabled'; ?>></td>
			</tr>
			</table>
